...
:main
	...
	for /l %%i in (1,%rotationSpeed%,1000000) do rem <-- throttle
goto :main
...
set /a "color[0]=0","color[1]=7","color[2]=15","color[3]=8",   "rotationSpeed=10" & rem 1 = slowest
...
rem %_2bpp% "list1"."list2" where list1 & 2 contain 8 '2 digit' hex values
